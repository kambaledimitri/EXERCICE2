...
if(move_uploaded_file($_FILES['PHOTO']['tmp_name'],'images/'.$url_img)){
   require 'bd/connection.php';           
            $req=$db->prepare('INSERT INTO utilisateur(NOM,POST_NOM,USERNAME,PHOTO,EMAIL,TELEPHONE,MOTDEPASSE) VALUES (:NOM,:POST_NOM,:USERNAME,:PHOTO,:EMAIL,:TELEPHONE,:MOTDEPASSE)');
            $req->execute(array(            
            'NOM' =>$_POST['Nom'],
